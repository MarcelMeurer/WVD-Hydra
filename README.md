...
<details><summary>Open to see the release history. Current version is 1.0.6.2.</summary>

Release | Date | Changes & Notes
--- | --- | ---
1.0.6.02 | 2024-02-29 | Add: Create and rollout images based on a Marketplace plan (caution: using plans can result in additional costs for the plan)
